...
document.addEventListener("DOMContentLoaded", () => {
    ...
    /**
     * Toggles the main navigation menu drawer and updates UI state.
     */
    function toggleMenu() {
    ...
    for (let i = 0; i < customSelects.length; i += 1) {
        const [selElmnt] = customSelects[i].getElementsByTagName("select");
        ...
        for (let j = 1; j < selElmnt.length; j += 1) { // Start from 1 to skip placeholder
    ...
    /**
     * Closes all custom select boxes except the given element.
     * @param {HTMLElement} elmnt - The element to keep open.
     */
